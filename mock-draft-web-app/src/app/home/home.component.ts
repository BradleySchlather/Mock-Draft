...
export class HomeComponent {
  ...
  //To Do: Add a standard image array from the db when user isn't logged in. Create Default For Player List and put in method called getDefaultPlayerList() in player-list component.
