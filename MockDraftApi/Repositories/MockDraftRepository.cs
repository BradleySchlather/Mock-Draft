...
namespace MockDraftApi.Repositories
{
    public class MockDraftRepository
    {
        ...
        {
            return [
                new Player { Rank = 1, PlayerName = "Marvin Harrison Jr.", Position = "WR", HeightWeight = "6-4 / 205", College = "Ohio St", Class = "Jr", IsStar = true , IsBust = false },
                new Player { Rank = 2, PlayerName = "Caleb Williams", Position = "QB", HeightWeight = "6-1 / 215", College = "USC", Class = "Jr", IsStar = true, IsBust = false },
                new Player { Rank = 3, PlayerName = "Olumuyiwa Fashanu", Position = "OT", HeightWeight = "6-6 / 316", College = "PSU", Class = "Sr", IsStar = false, IsBust = false },
                new Player { Rank = 4, PlayerName = "Brock Bowers", Position = "TE", HeightWeight = "6-4 / 240", College = "Georgia", Class = "Sr", IsStar = true, IsBust = false },
                new Player { Rank = 5, PlayerName = "Joe Alt", Position = "OT", HeightWeight = "6-7 / 322", College = "ND", Class = "Sr", IsStar = false, IsBust = false },
                new Player { Rank = 6, PlayerName = "Drake Maye", Position = "QB", HeightWeight = "6-4 / 230", College = "UNC", Class = "Sr", IsStar = false, IsBust = true },
                new Player { Rank = 7, PlayerName = "JC Latham", Position = "OT", HeightWeight = "6-6 / 360", College = "Bama", Class = "Sr", IsStar = false, IsBust = false },
                new Player { Rank = 8, PlayerName = "Laiatu Latu", Position = "EDGE", HeightWeight = "6-5 / 265", College = "UCLA", Class = "Sr", IsStar = false, IsBust = false },
                new Player { Rank = 9, PlayerName = "Jared Verse", Position = "EDGE", HeightWeight = "6-4 / 260", College = "FSU", Class = "Sr", IsStar = false, IsBust = false },
                new Player { Rank = 10, PlayerName = "Dallas Turner", Position = "EDGE", HeightWeight = "6-4 / 252", College = "Bama", Class = "Sr", IsStar = false, IsBust = false }
            ];
        }
